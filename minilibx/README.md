...
Compile MinilibX
 ...
 - run ./configure or make
   ...
   libexec.a and libmlx_$(HOSTTYPE).a are created.
...
Install MinilibX
 ...
 - no installation script is provided. You may want to install
     - libexec.a and/or libmlx_$(HOSTTYPE).a in /usr/X11/lib or /usr/local/lib
     - exec.h in /usr/X11/include or /usr/local/include
